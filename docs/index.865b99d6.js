 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new tX(tW.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query),(function(e,t,r={}){let n=new tY;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,r,n,i){let s=new ok({next:r=>{s.eu(),t.enqueueAndForget(()=>s3(e,o)),r.fromCache&&"server"===n.source?i.reject(new tX(tW.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(r)},error:e=>i.reject(e)}),o=new s7(r,s,{includeMetadataChanges:!0,ua:!0});return s6(e,o)})(await oP(e),e.asyncQueue,t,r,n)),n.promise})(r,e._query).then(r=>new ac(t,n,e,r)))}(oW(am,"todos"));let t=[];return e.forEach(e=>{t.push(e)}),t}ap.addEventListener("click",async()=>{if(ad.value.trim()){let e=document.getElementById("taskInput"),t=e.value.trim();t&&(await ay(t),av(),e.value=""),av()}}),ag.addEventListener("click",e=>{"LI"===e.target.tagName&&e.target.remove()});var ab={};ab=new URL("service-worker.aeae032d.js",import.meta.url).toString();const aE=new URL(ab);"serviceWorker"in navigator&&navigator.serviceWorker.register(aE.href,{scope:"/5146-PWA/"}).then(e=>console.log("Service Worker Registered for scope:",aE.href,"with","file:///app.js")).catch(e=>console.error("Service Worker Error:",e)),window.addEventListener("error",function(e){console.error("Error occurred: ",e.message)});
//# sourceMappingURL=index.865b99d6.js.map
