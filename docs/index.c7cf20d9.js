 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let t8=new f.Integer([0xffffffff,0xffffffff],0);function t4(e){let t=(new TextEncoder).encode(e),r=new f.Md5;return r.update(t),new Uint8Array(r.digest())}function t7(e){let t=new DataView(e.buffer),r=t.getUint32(0,!0),n=t.getUint32(4,!0),i=t.getUint32(8,!0),s=t.getUint32(12,!0);return[new f.Integer([r,n],0),new f.Integer([i,s],0)]}class t9{constructor(e,t,r){if(this.bitmap=e,this.padding=t,this.hashCount=r,t<0||t>=8)throw new re(`Invalid padding: ${t}`);if(r<0||e.length>0&&0===this.hashCount)throw new re(`Invalid hash count: ${r}`);if(0===e.length&&0!==t)throw new re(`Invalid padding when bitmap length is 0: ${t}`);this.Ee=8*e.length-t,this.de=(0,f.Integer).fromNumber(this.Ee)}Ae(e,t,r){let n=e.add(t.multiply((0,f.Integer).fromNumber(r)));return 1===n.compare(t8)&&(n=new f.Integer([n.getBits(0),n.getBits(1)],0)),n.modulo(this.de).toNumber()}Re(e){return!!(this.bitmap[Math.floor(e/8)]&1<<e%8)}mightContain(e){if(0===this.Ee)return!1;let[t,r]=t7(t4(e));for(let e=0;e<this.hashCount;e++){let n=this.Ae(t,r,e);if(!this.Re(n))return!1}return!0}static create(e,t,r){let n=new t9(new Uint8Array(Math.ceil(e/8)),e%8==0?0:8-e%8,t);return r.forEach(e=>n.insert(e)),n}insert(e){if(0===this.Ee)return;let[t,r]=t7(t4(e));for(let e=0;e<this.hashCount;e++){let n=this.Ae(t,r,e);this.Ve(n)}}Ve(e){let t=Math.floor(e/8);this.bitmap[t]|=1<<e%8}}class re extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sV(e){e=iZ(e,i3);let t=iZ(e.firestore,se);return(function(e,t,r={}){let n=new k;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,r,n,i){let s=new iF({next:a=>{s.su(),t.enqueueAndForget(()=>ie(e,o));let l=a.docs.has(r);!l&&a.fromCache?i.reject(new A(C.UNAVAILABLE,"Failed to get document because the client is offline.")):l&&a.fromCache&&n&&"server"===n.source?i.reject(new A(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(a)},error:e=>i.reject(e)}),o=new is(new ta(r.path),s,{includeMetadataChanges:!0,Ta:!0});return n9(e,o)})(await iK(e),e.asyncQueue,t,r,n)),n.promise})(sr(t),e._key).then(r=>(function(e,t,r){let n=r.docs.get(t._key),i=new sF(e);return new sL(e,i,t._key,n,new sP(r.hasPendingWrites,r.fromCache),t.converter)})(t,e,r))}class sF extends sO{constructor(e){super(),this.firestore=e}convertBytes(e){return new sn(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new i3(this.firestore,null,t)}}function sB(e){e=iZ(e,i6);let t=iZ(e.firestore,se),r=sr(t),n=new sF(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tS{constructor(e){this.providerId=tS.PROVIDER_ID,this.auth=eb(e)}verifyPhoneNumber(e,t){return tI(this.auth,e,(0,o.getModularInstance)(t))}static credential(e,t){return eW._fromVerification(e,t)}static credentialFromResult(e){return tS.credentialFromTaggedObject(e)}static credentialFromError(e){return tS.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;let{phoneNumber:t,temporaryProof:r}=e;return t&&r?eW._fromTokenResponse(t,r):null}}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let tG=new I(3e4,6e4);function tW(){let e=tl().___jsl;if(null==e?void 0:e.H){for(let t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}}let tQ=null,tX=new I(5e3,15e3),tJ={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},tY=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);async function tZ(e){let t=await (tQ=tQ||new Promise((t,r)=>{var n,i,s,o;function a(){tW(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{tW(),r(g(e,"network-request-failed"))},timeout:tG.get()})}if(null===(i=null===(n=tl().gapi)||void 0===n?void 0:n.iframes)||void 0===i?void 0:i.Iframe)t(gapi.iframes.getContext());else if(null===(s=tl().gapi)||void 0===s?void 0:s.load)a();else{let t=eS("iframefcb");return tl()[t]=()=>{gapi.load?a():r(g(e,"network-request-failed"))},(o=`${eT.gapiScript}?onload=${t}`,eT.loadJS(o)).catch(e=>r(e))}}).catch(e=>{throw tQ=null,e})),r=tl().gapi;return w(r,e,"internal-error"),t.open({where:document.body,url:function(e){let t=e.config;w(t.authDomain,e,"auth-domain-config-required");let r=t.emulator?T(t,"emulator/auth/iframe"):`https://${e.config.authDomain}/__/auth/iframe`,n={apiKey:t.apiKey,appName:e.name,v:s.SDK_VERSION},i=tY.get(e.config.apiHost);i&&(n.eid=i);let a=e._getFrameworks();return a.length&&(n.fw=a.join(",")),`${r}?${(0,o.querystring)(n).slice(1)}`}(e),messageHandlersFilter:r.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:tJ,dontclear:!0},t=>new Promise(async(r,n)=>{await t.restyle({setHideOnLeave:!1});let i=g(e,"network-request-failed"),s=tl().setTimeout(()=>{n(i)},tX.get());function o(){tl().clearTimeout(s),r(t)}t.ping(o).then(o,()=>{n(i)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
//# sourceMappingURL=index.c7cf20d9.js.map
